...
export default async function MarketingLayout({
  ...
  return (
    <div className="flex min-h-screen max-w-2xl mx-auto flex-col">
      <header className="container sticky top-0 z-40">
        <div className="flex h-16 items-center justify-between border-b-0 border-b-slate-200 dark:border-b-slate-800 py-4">
